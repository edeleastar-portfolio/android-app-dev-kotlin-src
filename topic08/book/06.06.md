# Landscape Placemark Activity

Introduce a new landscape version of the PlacemarkActivity. This will be a new layout, which you can create in the layout editor:
...
Which will be a copy of the original:

![](img/12.png)

You can start to reorganize into something more coherent:
